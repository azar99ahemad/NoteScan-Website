      ...
      <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
        ...
        <div className="hidden md:flex gap-10 items-center">
          <button
            onClick={() => setPage("home")}
            className={
              currentPage === "home" ? "text-indigo-600 font-bold" : "font-bold"
            }
          >
            Product
          </button>
...
const Section: React.FC<{
  ...
  <section id={id} className={`py-24 md:py-40 px-6 ${bg} ${className}`}>
    <div className="max-w-6xl mx-auto">
      {title && (
        <h2 className="text-4xl md:text-5xl font-black mb-16 text-slate-900 tracking-tighter text-center">
          {title}
        </h2>
      )}
      {children}
      ...
      <header className="relative pt-48 pb-32 px-6 overflow-hidden min-h-[90vh] flex items-center">
        ...
        <div className="max-w-5xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-white/50 backdrop-blur-md text-indigo-700 text-sm font-extrabold uppercase tracking-widest mb-10 border border-indigo-100/50 shadow-sm animate-in slide-in-from-bottom-2">
            <Zap size={16} className="fill-indigo-600" /> Powered by On-Device
            AI
          </div>
          ...
          <p className="text-xl md:text-2xl text-slate-500 max-w-2xl mx-auto leading-relaxed mb-14 font-medium animate-in slide-in-from-bottom-6 duration-700">
            NoteScan turns the physical world into digital data instantly.
            High-precision OCR that never compromises your privacy.
          </p>
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center animate-in slide-in-from-bottom-8 duration-900">
            <a
              href="https://www.indusappstore.com/apps/tools/notescan/com.example.notescan?page=details&id=com.example.notescan"
              target="_blank"
        ...
        <div className="flex flex-col md:flex-row items-center gap-16 text-white text-center md:text-left">
          <div className="flex-1 space-y-8">
            <h2 className="text-5xl font-black tracking-tight leading-[1.1]">
              Privacy isn't an option. <br /> It's the standard.
            </h2>
            <p className="text-indigo-100 text-xl leading-relaxed font-medium">
              Most OCR apps send your documents to their servers to "improve the
              model". We don't. Your sensitive data stays where it belongs—with
              you.
            </p>
        ...
        <div className="bg-slate-900 rounded-[3rem] p-12 md:p-24 text-center space-y-12 relative overflow-hidden">
          ...
          <div className="space-y-4">
            ...
            <p className="text-slate-400 text-xl font-medium max-w-xl mx-auto">
              We're a small team dedicated to building great tools. Reach out if
              you need help.
            </p>
          </div>
          <a
            href="mailto:az99ahemad@gmail.com"
            className="inline-flex items-center gap-3 text-3xl md:text-5xl font-black text-white hover:text-indigo-400 transition-colors group"
          >
...
const PrivacyPolicyPage: React.FC<{ setPage: (p: Page) => void }> = ({
  setPage,
}) => {
  return (
            ...
            <div className="space-y-20">
              <section className="space-y-6">
                ...
                <p className="text-xl text-slate-500 leading-relaxed font-medium">
                  At NoteScan, privacy isn't just a legal requirement—it's the
                  core of our engineering philosophy. We built this app because
                  we were tired of tools that trade functionality for user data.
                </p>
              </section>
              ...
              <div className="grid md:grid-cols-2 gap-10">
                <div className="p-10 bg-slate-50 rounded-[2.5rem] space-y-4">
                  ...
                  <p className="text-slate-500 font-medium">
                    We do not collect personal identifiers, device data, or scan
                    metadata. We have no way to identify you.
                  </p>
                </div>
                <div className="p-10 bg-slate-50 rounded-[2.5rem] space-y-4">
                  <h3 className="text-xl font-black text-slate-900">
                  ...
                  <p className="text-slate-500 font-medium">
                    Zero tracking. We don't track buttons clicks, session times,
                    or crash reports through third parties.
                  </p>
                </div>
              </div>
                  ...
                  {[
                    {
                      ...
                      title: "Camera",
                      desc:
                        "Used strictly for scanning. No images are saved without your command, and none are ever uploaded.",
                    },
                    {
                      icon: <HardDrive size={20} />,
                      title: "Storage",
                      desc:
                        "Allows you to import local photos or save extracted text files. Only used per user request.",
                    },
                    // {
                    //   icon: <Scale size={20} />,
                    //   title: "Compliance",
                    ...
                    <div
                      key={i}
                      className="flex gap-6 items-start p-8 border border-slate-100 rounded-3xl group hover:border-indigo-100 transition-colors"
                    >
              ...
              <section className="bg-slate-900 text-white p-12 rounded-[3rem] text-center space-y-6">
                ...
                <p className="text-slate-400 font-medium leading-relaxed max-w-lg mx-auto">
                  Even though we don't store your data, we recommend using
                  device-level security like FaceID/Passcode to protect your
                  local scans.
                </p>
                <div className="pt-6">
                  <a
          ...
          <div className="grid md:grid-cols-4 gap-20 mb-24">
            <div className="col-span-2 space-y-8">
              ...
              <p className="text-slate-500 max-w-sm leading-relaxed font-bold text-lg">
                Privacy-first OCR technology built for the modern user. Extract
          ...
          <div className="pt-12 border-t border-slate-200 flex flex-col md:flex-row justify-between items-center gap-6 text-slate-400 font-bold tracking-tight">
            ...
            <div className="flex gap-10">
              <span className="flex items-center gap-2">
                <ShieldCheck size={16} /> Encryption Enabled
              </span>
              <span className="flex items-center gap-2">
